...
export const SUBTEXT_SETS: SubtextSet[] = [
  ...
  {
    id: 'workplace_undercurrents',
    title: 'Workplace Undercurrents',
    description: 'The coded language of office politics — what bosses and coworkers really mean beneath professional polish',
    difficulty: 3,
    prompts: [
      {
        id: 'wu_1',
        ...
        speaker: 'Your boss',
        context: 'You raised a concern about the project timeline in a team meeting and others were starting to agree.',
        actualSubtext: 'I want to shut down this dissent publicly before it gains momentum and makes me look like I lack control',
        underlyingEmotion: 'anxiety',
        difficulty: 3,
        skillTrack: 'defend',
      },
      {
        ...
        statement: 'Per my last email...',
        speaker: 'Your boss',
        context: 'You asked them to clarify a deliverable that was vaguely described in a previous message.',
        actualSubtext: "I'm frustrated that you didn't read or follow through on what I already communicated and I want you to know it",
        underlyingEmotion: 'anger',
        difficulty: 2,
        skillTrack: 'listen',
      },
      {
        id: 'wu_3',
        statement: "I'll let you handle that.",
        speaker: 'Your manager',
        context: 'A risky client situation just escalated and you brought it to their attention for guidance.',
        actualSubtext: "I don't want responsibility if this goes wrong so I'm delegating the risk to you while framing it as trust",
        underlyingEmotion: 'fear',
        difficulty: 3,
        skillTrack: 'defend',
      },
      {
        id: 'wu_4',
        statement: "That's certainly one approach.",
        speaker: 'A senior director',
        context: 'You just presented your proposed strategy in a cross-functional meeting.',
        actualSubtext: "I think your approach is wrong but I'm not going to say that directly in front of everyone",
        underlyingEmotion: 'frustration',
        difficulty: 3,
        skillTrack: 'listen',
      },
      {
        id: 'wu_5',
        statement: 'We need to be more strategic about this.',
        speaker: 'Your VP',
        context: 'You pitched an initiative you spent weeks preparing and they responded immediately.',
        actualSubtext: "Your idea isn't good enough but I'm wrapping my rejection in aspirational language so it doesn't feel like a no",
        underlyingEmotion: 'frustration',
        difficulty: 4,
        skillTrack: 'regulate',
      },
  ...
  {
    id: 'dating_early_relationships',
    title: 'Dating & Early Relationships',
    description: 'The subtext hiding in the early stages of romance — what people say vs. what they signal',
    difficulty: 2,
    prompts: [
      {
        id: 'der_1',
        statement: "I'm not really looking for anything serious right now.",
        speaker: 'Someone you have been on three dates with',
        context: 'Things seemed to be going well. You just suggested making plans for next weekend.',
        actualSubtext: "I'm not interested in commitment with you specifically but I want to keep seeing you casually without feeling guilty",
        underlyingEmotion: 'anxiety',
        difficulty: 2,
        skillTrack: 'listen',
      },
      {
        id: 'der_2',
        statement: "You're so different from anyone I've ever dated.",
        speaker: 'A new romantic interest',
        context: 'You have only been seeing each other for two weeks and they are already very intense.',
        actualSubtext: 'This could be genuine appreciation or a love-bombing tactic to accelerate intimacy faster than trust has been earned',
      ...
      },
      {
        ...
        speaker: 'Your partner of two months',
        context: 'You noticed they have been texting less and asked if everything is okay.',
        actualSubtext: "I'm pulling away and I may not come back but I'm not ready to end things outright so I'm buying time",
        underlyingEmotion: 'fear',
        difficulty: 2,
        skillTrack: 'empathize',
      },
      {
        id: 'der_4',
        statement: 'We should hang out sometime.',
        speaker: 'Someone you matched with on a dating app',
        context: 'You have been texting for a week. They say this but never suggest a specific day or place.',
        actualSubtext: "I want to keep you as an option and maintain the connection but I'm not motivated enough to actually initiate plans",
        underlyingEmotion: 'ambivalence',
        difficulty: 1,
        skillTrack: 'listen',
      },
      {
        id: 'der_5',
        statement: 'My ex was crazy.',
        speaker: 'Someone on a first date',
        context: 'You asked casually about their past relationships and they immediately blamed their ex.',
        actualSubtext: 'I may lack self-awareness about my own role in that relationship ending and I use blame to avoid examining my patterns',
        underlyingEmotion: 'defensiveness',
        difficulty: 3,
        skillTrack: 'defend',
      },
    ],
